    ...
    public class AddressesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Addresses != null ? 
                          ...
                          Problem("Entity set 'DataContext.Addresses'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstLine,SecondLine,ThirdLine,City,PostCode,EngineerId")] Address address)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstLine,SecondLine,ThirdLine,City,PostCode,EngineerId")] Address address)
        {
            if (id != address.Id)
            {
                return NotFound();
