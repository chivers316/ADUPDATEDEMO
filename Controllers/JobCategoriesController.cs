    ...
    public class JobCategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.JobCategories != null ? 
                          ...
                          Problem("Entity set 'DataContext.JobCategories'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,CategorySelected,EngineerId")] JobCategory jobCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CategorySelected,EngineerId")] JobCategory jobCategory)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DataContext.JobCategories'  is null.");
            }
            var jobCategory = await _context.JobCategories.FindAsync(id);
            if (jobCategory != null)
            {
